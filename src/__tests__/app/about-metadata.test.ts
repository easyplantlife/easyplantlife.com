/**
 * About Page SEO Metadata Tests
 *
 * Tests for the About page SEO metadata following TDD approach.
 * Based on acceptance criteria from issue #34 (M5-03):
...
describe("About Page SEO Metadata", () => {
  ...
  describe("Page Title", () => {
    ...
    it("title is exactly 'About | Easy Plant Life'", () => {
      expect(metadata.title).toBe("About | Easy Plant Life");
    });
  });
  ...
  describe("Meta Description", () => {
    ...
    it("description reflects about page content", () => {
      const description = (metadata.description || "").toLowerCase();
      // Should contain relevant keywords about the brand/philosophy
      const hasRelevantContent =
        description.includes("easy plant life") ||
        description.includes("philosophy") ||
  ...
  describe("Open Graph Metadata", () => {
    ...
    it("Open Graph title includes 'About' and 'Easy Plant Life'", () => {
